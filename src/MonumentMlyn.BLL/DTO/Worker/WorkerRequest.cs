...
namespace MonumentMlyn.BLL.DTO
{
    public class WorkerRequest
    {
        ...
        public WorkerRequest(string firstName, decimal numberOfHours, decimal rete, string phone, decimal salary, string lastName, DateTime? createWorcer, DateTime? updateWorker)
        {
            FirstName = firstName;
